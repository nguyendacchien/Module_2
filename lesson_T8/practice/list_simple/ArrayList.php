...
class ArrayList
{
    ...
    public function add($obj): void   //thêm pt vào cuối
    {
        array_push($this->arrayList, $obj);
    }

    public function clear(): void  // xóa tất cả pt
    {
        $this->arrayList=[];

    }

    public function get($index)   // trả về pt tại vị trí index
    {
    ...
    public function remove($index)    // xóa pt ở vị trí index
    {
